...
Introduction
-------
This guide is intended for game developers using Android native code. In addition to the documents, we also provide the demo called U8SDKTest4. 
...
Please copy u8sdk3.jar and android-support-multidex.jar to the libs folder of the Game Project. You can import our demo project named U8SDKTest4 into eclipse for a refrence.
...
If the game does not have its own Application， then the game just need to specify the application in AndroidManifest.xml as com.u8.sdk.U8Application. you can refer to the picture below.

![Application 配置](images/application_config.png)

If the game has its own Application, you can define a subclass of com.u8.sdk.U8Application, and then config the android:name of the application node as the subclass.

2.2 Set Permissions

Please add permsssions in application node：
